Locales['de'] = {
    ...
    ['barman_outfit']            = 'Barkeeper Outfit',
    ...
    ['vehicle_spawner']          = 'Drücke ~INPUT_CONTEXT~ um ein Fahrzeug auszulagern',
    ['store_vehicle']            = 'Drücke ~INPUT_CONTEXT~ um das Fahrzeug einzulagern',
    ['service_max']              = 'Full service: ',
    ['spawn_point_busy']         = 'Ein Fahrzeug befindet sich schon in der Nähe des Spawns!',
    ...
    ['e_to_enter_2']             = 'Drücke ~INPUT_PICKUP~ um auf das Dach zu gehen.',
    ['e_to_exit_2']              = 'Drücke ~INPUT_PICKUP~ um nach unten in den Nachtclub zu gehen.',
